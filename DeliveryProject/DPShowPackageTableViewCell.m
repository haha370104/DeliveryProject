...
@interface DPShowPackageTableViewCell ()
...
@implementation DPShowPackageTableViewCell
...
{
    if (self.delegate) {
        [self.delegate DPShowPackageTableViewCell:self indexPath:self.indexPath];
    }
}
...
- (UIButton *)rightButton
{
    if (!_rightButton) {
        ...
        [_rightButton setTitle:@"选择接单" forState:UIControlStateNormal];
